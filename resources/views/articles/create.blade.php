            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                    <div>
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 mb-2 flex">
                                <div class="w-64">
                                    ...
                                    <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" value="" required autofocus autocomplete="title" />
                        ...
                        <textarea name="content" placeholder="{{ __('Article...') }}" class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{ old('message') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="mt-4">
